 ...
 * @author sandip
 */
public class CustomerHandlerDashboard extends javax.swing.JFrame {
     ...
     */
    public CustomerHandlerDashboard() {
        initComponents();
    ...
    private void initComponents() {
        ...
        searchText.setText("Search for customer detailss");
   ...
   public boolean[] customerDetailsValidation()
   {
       ...
       validresult[0]= (pattern1.matcher(CustomerEmailId.getText()).matches());
       validresult[1]= (pattern2.matcher(customerMobNumber.getText()).matches());
       return validresult;
   }
    ...
    private void addCusstomerbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCusstomerbActionPerformed
        ...
        if(customerFullName.getText().equals("")||customerMobNumber.getText().equals("")||CustomerEmailId.getText().equals("")||customerMobNumber.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Some Customer field are Empty ","Error",JOptionPane.ERROR_MESSAGE);
             else if(customerDetailsValidation()[0]==false)
                JOptionPane.showMessageDialog(this,"Please Enter Correct Email id  ","Error",JOptionPane.ERROR_MESSAGE);
              else if(customerDetailsValidation()[1]==false)
                JOptionPane.showMessageDialog(this,"Please Enter Correct Mob Number  ","Error",JOptionPane.ERROR_MESSAGE);
              else
            {
